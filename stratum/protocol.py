...
class Protocol(LineOnlyReceiver):
    ...
    def connectionMade(self):
        ...
        self.on_finish = None  # Will point to defer which is called once all client requests are processed
    ...
    def connectionLost(self, reason):
        if self.on_disconnect is not None and not self.on_disconnect.called:
    ...
    def lineReceived(self, line, request_counter):
        ...
        if msg_method:
            ...
            try:
                ...
                if result is None and msg_id is not None:

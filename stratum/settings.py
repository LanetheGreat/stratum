'''
This is the default configuration for Stratum server.
'''
...
# Please copy everything above this line to config.py and fill in correct values.


def setup():
    '''
        This will import the module "config" and move its variables into current module.
